...
<img width="1208" height="958" alt="Screenshot 2025-11-20 at 23 17 01" src="https://github.com/user-attachments/assets/477f02e7-1741-4a9b-810b-2bfe2e5a3a99" />

## Inputs

### `token`

**Required** – Slack app token. See [Slack's documentation](https://docs.slack.dev/authentication/tokens/#bot).
**To get a token:**
...
**_Optional_** – The folder where Cypress stores screenshots on the build machine.
...
**_Optional_** – The folder where Cypress stores videos on the build machine.
Default: `cypress/videos`

### `message-text`

**_Optional_** – Custom Slack message for when the screenshots and videos have been uploaded.
Default: `A Cypress test just finished. I've placed the screenshots and videos in this thread. Good pie!`

### `uploadType`

**_Optional_** – What to upload: `"both"`, `"screenshots"`, or `"videos"`.
Default: `both`
  ...
  test-and-upload-results-on-fail:
    ...
    steps:
      ...
      - name: 'Upload screenshots and videos to Slack'
        uses: trymbill/cypress-slack-video-upload-action@v2.1.0
        if: failure()
        with:
